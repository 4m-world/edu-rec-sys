namespace CodeMatrix.Mepd.Host.Configurations;
    ...
    internal static ConfigureHostBuilder AddConfigurations(this ConfigureHostBuilder host)
    {
        host.ConfigureAppConfiguration((context, config) =>
        {
            ...
            config.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/monitoring.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/monitoring.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
