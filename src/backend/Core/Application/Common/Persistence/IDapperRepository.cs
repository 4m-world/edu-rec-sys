...
public interface IDapperRepository : ITransientService
{
    ...
    Task<PaginationResponse<T>> QueryAsync<T>(string sql, int pageNumber, int pageSize, object param = null, IDbTransaction transaction = null, CancellationToken cancellationToken = default)
       where T : class;
