...
public class TokenService : ITokenService
{
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress)
    {
        return new List<Claim>
        {
            ...
            new(MepdClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(MepdClaims.IpAddress, ipAddress),
            new(MepdClaims.Tenant, _currentTenant.Id),
            new(MepdClaims.ImageUrl, user.ImageUrl ?? string.Empty),
            new(MepdClaims.Phone, user.PhoneNumber?? string.Empty),
        };
    }
