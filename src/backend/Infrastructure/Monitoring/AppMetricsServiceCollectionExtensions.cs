...
namespace CodeMatrix.Mepd.Infrastructure.Monitoring
{
    ...
    {
        public static IServiceCollection AddAppMetric(this IServiceCollection services, IConfiguration config)
        {
            var appMetricsOptions = config.GetSection(nameof(AppMetricsOptions)).Get<AppMetricsOptions>();
