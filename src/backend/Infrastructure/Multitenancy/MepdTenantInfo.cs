...
public class MepdTenantInfo : ITenantInfo
{
    public MepdTenantInfo() { }

    public MepdTenantInfo(string id, string name, string connectionString, string adminEmail, string issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
