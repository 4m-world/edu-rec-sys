                ...
                bearer.Events = new JwtBearerEvents
                {
                    ...
                    OnMessageReceived = context =>
                    {
                        ...
                        if (!string.IsNullOrEmpty(accessToken))// && (
                            //context.HttpContext.Request.Path.StartsWithSegments("/dashboard/shops/map", StringComparison.OrdinalIgnoreCase) ||
                            //context.HttpContext.Request.Path.StartsWithSegments("/dashboard/beneficiaries-map-data", StringComparison.OrdinalIgnoreCase) ||
