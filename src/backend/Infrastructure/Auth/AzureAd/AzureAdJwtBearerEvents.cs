...
namespace CodeMatrix.Mepd.Infrastructure.Auth.AzureAd;
...
internal class AzureAdJwtBearerEvents : JwtBearerEvents
{
    ...
    public override async Task TokenValidated(TokenValidatedContext context)
    {
        ...
        // Adding tenant claim.
        identity.AddClaim(new Claim(MepdClaims.Tenant, tenant.Id));
        ...
        string userId = await context.HttpContext.RequestServices.GetRequiredService<IIdentityService>()
