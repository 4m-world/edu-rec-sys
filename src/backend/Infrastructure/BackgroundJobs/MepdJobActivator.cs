...
public class MepdJobActivator : JobActivator
{
    private readonly IServiceScopeFactory _scopeFactory;

    public MepdJobActivator(IServiceScopeFactory scopeFactory)
    {
    ...
    private class Scope : JobActivatorScope, IServiceProvider
    {
        ...
        {
            var tenantInfo = _context.GetJobParameter<MepdTenantInfo>(MultitenancyConstants.TenantIdName);
